package edunova02.src.edunova.obrada;


import java.util.ArrayList;
import java.util.List;

import edunova02.src.edunova.model.Grupa;
...
public class Grupe {
	...
	private List<edunova02.src.edunova.model.Grupa> grupe;
	private edunova01.Start start;
	
	public Grupe(edunova01.Start start) {
		super();
		this.start = start;
		grupe = new ArrayList<>();
	...
	public Grupe(List<edunova02.src.edunova.model.Grupa> grupe, edunova01.Start start) {
		super();
		this.grupe = grupe;
		this.start = start;
	...
	private void odabirIzbornika() {
		switch (edunova01.Pomocno.ucitajCijeliBrojURasponu("Odaberi opciju: ", 1, 5)) {
		case 1:
			pregled(true);
			break;
		case 2:
...
//			}
	...
	private void unosNovog() {
		edunova02.src.edunova.model.Grupa g = new edunova02.src.edunova.model.Grupa();
		g.setSifra(edunova01.Pomocno.ucitajCijeliBrojURasponu("Unesi šifru grupe: ", 1, Integer.MAX_VALUE));
		g.setNaziv(edunova01.Pomocno.obavezanUnosStringa("Unesi naziv grupe: "));

		//start.getSmjerovi().pregled(false);
		//int rb = edunova01.Pomocno.unosBrojRaspon("Odabrite smjer na kojem je grupa: ", 1, 
		...
		while(true) {
			...
			//rb = edunova01.Pomocno.unosBrojRaspon("Odabrite polaznika za dodavanje na grupu: ", 1, 
